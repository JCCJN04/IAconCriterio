...
export function Hero() {
  return (
    <section className="relative py-20 md:py-32 px-6 bg-gradient-to-b from-primary/5 to-transparent">
      <div className="absolute inset-0 bg-[url('/inicio.jpg')] bg-cover bg-center opacity-75"></div>
      <div className="relative mx-auto max-w-4xl flex flex-col items-center text-center z-10">
        ...
        {/* Descripción */}
        <p className="text-lg text-white mb-12 leading-relaxed max-w-2xl">
          Aprende a pensar mejor <span className="font-semibold text-white">con IA</span>, no a dejar que piense por ti.
        </p>
